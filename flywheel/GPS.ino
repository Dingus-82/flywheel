...
Code modified for PICOLO by: Radhakrishna Vojjala
Date of last modification: 21th Mar 2025
_____________________________________________________________
*/
...
void GPSsetup() {
  ...
  for(int i = 0; (i < 5) && (!gpsStatus); i++){
    Serial1.begin(gpsBaud);
    gpsStatus = sparkFunGNSS.begin(Serial1);
  }
